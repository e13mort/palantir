...
class Test {
    @Test
    fun testRanges() {
        val testRange = "01-01-2024:01-02-2024:01-03-2024:01-04-2024:01-05-2024:01-06-2024:01-07-2024"
        val converter = StringDateConverter { string -> SimpleDateFormat("dd-MM-yyyy").parse(string).time }
        val ranges = testRange.asRanges(converter)
